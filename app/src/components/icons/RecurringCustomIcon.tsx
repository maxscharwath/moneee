...
export const RecurringCustomIcon = React.forwardRef<
	SVGSVGElement,
...
>((props, forwardedRef) => (
	...
	>
		...
		<path d="M21 3V8H16" />
		<path d="M19 12H18C16.3431 12 15 13.3431 15 15C15 16.6569 16.3431 18 18 18H19" />
	</svg>
));

RecurringCustomIcon.displayName = "RecurringCustomIcon";
