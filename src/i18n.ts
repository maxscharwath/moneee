...
export const languages = [
	...
	{code: 'fr-FR', name: 'Français', locale: fr},
	{code: 'fr-CH', name: 'Français (Suisse)', locale: frCH},
	{code: 'de', name: 'Deutsch', locale: de},
	{code: 'de-CH', name: 'Deutsch (Schweiz)', locale: de},
	{code: 'es', name: 'Español', locale: es},
	{code: 'it', name: 'Italiano', locale: it},
	{code: 'it-CH', name: 'Italiano (Svizzera)', locale: itCH},
];

export const useLocale = () => {
	const translation = useTranslation();
	const [settings] = useSettings();
	const currency = useCallback((amount: number, options?: Intl.NumberFormatOptions) => amount.toLocaleString(translation.i18n.language, {
		style: 'currency',
